...
export const events: EventDef[] = [
  ...
  { id: 'dangdang_lining', title: '磨手的護臂', hero: 'dangdang', acts: [1, 2],
    text: '噹噹抬起左手，護臂裡忽然一陣刺痛。他卸開扣帶，發現布墊已磨穿，銅邊在手腕上刮出一道紅痕。噹噹：「難怪越戴越疼。」工具袋裡還有一塊厚布，也放著包紮用的藥布。他把兩樣攤到膝上，試著屈伸手腕。',
    choices: [
  ...
  { id: 'ninja_target', title: '滿是刀痕的木靶', hero: 'ninja', acts: [1, 2],
    ...
    choices: [
      ...
      { label: '撿還能用的暗器（隨機獲得 1 張罕見忍術牌）', outcome: [{ kind: 'addRandomCard', pool: '忍術', rarity: '罕見' }],
        result: '球球從靶上拔下幾枚手裏劍，斷掉的丟在地上，挑出三枚還能用的。握在手裡比了比，總算想通靶心是怎麼磨亮的。球球：「原來出手前要先轉手腕喵。」', resultArt: 'ninja_target_r1' },
