...
export const events: EventDef[] = [
   ...
   */
  { id: 'dangdang_lining', title: '磨手的護臂', hero: 'dangdang', acts: [1, 2], artPending: true,
    text: '噹噹抬起右手，護臂裡忽然一陣刺痛。他卸開扣帶，發現布墊已磨穿，銅邊在手腕上刮出一道紅痕。噹噹：「難怪越戴越疼。」工具袋裡還有一塊厚布，也放著包紮用的藥布。他把兩樣攤到膝上，試著屈伸手腕。',
    choices: [
      ...
      { label: '先敷藥，讓手腕歇一會兒（回復 16 點生命）',
        ...
        result: '噹噹拿藥布敷住傷處，把護臂放在旁邊。等疼痛減輕，他活動手指，墊入厚布，再鬆鬆扣回去。噹噹：「先別磨到傷口。重新調整，等下一次休息。」', resultArt: 'dangdang_lining_r1' },
      { label: '調鬆扣帶，繼續上路（無效果）',
        outcome: [],
        result: '噹噹把扣帶放鬆，將衣袖拉進銅邊和手腕之間。他抬了抬手，沒有再刮到剛才那處傷。噹噹：「先墊著，找到地方再拆。」' },
    ] },
  { id: 'dangdang_toolbox', title: '偷走的工具箱', hero: 'dangdang', acts: [1, 2], artPending: true,
    text: '一隻老鼠推著板車經過，車上壓著一只舊木箱。箱角包了三塊銅片，第四角卻只釘著薄木板。噹噹攔住車：「那只工具箱，是我的。」老鼠瞇起眼：「我從魔物那裡換來的。你說是你的，有什麼證據？」噹噹說：「底下有一排釘錯的孔。打開，裡面那把鉗子少半截柄。」老鼠掀開箱子，看見斷柄鉗，耳朵頓時垂了下來，扶著歪斜的車輪說：「好吧，箱子還你。你肯順便修車，我再付工錢。」輪軸已經歪了，要修得先把整車的東西抬起來。噹噹摸了摸痠痛的肩膀。',
    choices: [
      ...
      { label: '收回工具，再替老鼠修車（失去 6 點生命、獲得 45 條小魚乾）',
        ...
        result: '噹噹抬住車板，讓老鼠抽出歪掉的輪軸，再一起把它敲正。放下車時，他腰側猛地一疼，只能扶著車緩氣。老鼠把工錢遞來。噹噹：「下次先卸貨。這樣抬，腰真受不了。」', resultArt: 'dangdang_toolbox_r1' },
      { label: '只取回工具，繼續趕路（無效果）',
        outcome: [],
        result: '噹噹挑出能用的工具收好，指了指鬆動的車軸。噹噹：「重的搬到另一頭，這邊別再壓。修車得另找人，我還要上樓。」' },
    ] },
  /*
   * 一掌留下的凹痕：**這一段是進塔前的回憶**，球球、菲菲出現在回憶裡，
   * 不代表這一刻跟他同行（稿子特別交代過這件事）。
   */
  { id: 'dangdang_old_dent', title: '一掌留下的凹痕', hero: 'dangdang', acts: [2], artPending: true,
    text: '噹噹靠著空房裡的木柱歇腳，擦去護臂上的灰。新刮痕底下，有一處早已磨圓的凹痕。他用拇指按了按，想起村裡的一次練習——院子裡，球球擺好架勢喊：「我出招了喵！」噹噹剛戴上做好的護臂，兩腳站得太近，被撞得連退幾步，背碰到了牆。他皺著眉：「手都擋住了，怎麼還會退這麼遠？」大俠貓走到兩人中間，把他的腳往外挪，壓低肩膀，再伸掌推來。噹噹沒有立刻頂回去，等腳踩穩了，才把護臂往前送。第二回大俠貓加了些力道，銅面凹下一小塊，他膝蓋彎了彎，終於沒再退到牆邊。樓上的腳步聲讓噹噹回過神。他放下擦布，低頭看了看自己的腳。',
    choices: [
      { label: '照記得的站姿重新練習（升級至多 1 張牌）',
        outcome: [{ kind: 'upgradeCard' }],
        result: '噹噹把兩腳挪開，對著木柱練習承力，再把手往前送。做到最後幾次，腳下總算沒再打滑。噹噹：「對，就是這個位置。」', resultArt: 'dangdang_old_dent_r0' },
      { label: '捨去總讓自己失去重心的招式（自選移除 1 張牌）',
        outcome: [{ kind: 'removeCard' }],
        result: '噹噹試過幾個熟悉的動作。有一招每次使到一半，身子就會往前栽。他收回手，決定不再用它。噹噹：「這招配不上我的站法，換掉。」', resultArt: 'dangdang_old_dent_r1' },
      { label: '收起擦布，繼續找人（無效果）',
        outcome: [],
        result: '噹噹把擦布塞回工具袋，重新扣緊護臂。走出房門前，他又看了一眼那處舊凹痕。噹噹：「大俠貓，等找到您，我再試一次給您看。」' },
    ] },
  { id: 'dangdang_jammed_gate', title: '歪掉的門框', hero: 'dangdang', acts: [1, 2], artPending: true,
  ...
  { id: 'seclusion', title: '閉關',
    ...
    choices: [
      { label: '對著爪痕練招（升級至多 1 張牌）', outcome: [{ kind: 'upgradeCard' }], result: '球球照著牆上的爪痕練了幾次，發現自己出手的角度可以再改一點。球球：「原來要往這邊，我再試試喵。」', resultArt: 'seclusion_r0' },
      { label: '打坐休息（回復 10 點生命）', outcome: [{ kind: 'heal', n: 10 }], result: '球球盤腿坐下，沒多久就睡著了。醒來時，肩膀和背都舒服了些。球球：「睡了多久喵？該出發了喵。」', resultArt: 'seclusion_r1' },
    ] },
  ...
  { id: 'gambling_rats', title: '賭博的老鼠',
    ...
    choices: [
      { label: '下注 50 條小魚乾（70% 機率領取 130 條，淨賺 80 條；否則輸掉本錢）', costFish: 50,
        ...
        result: '球球放下本錢，緊盯著老鼠手裡的碗。碗一掀開，牠立刻湊上前看。球球：「結果出來了，該算清楚了喵。」', resultArt: 'gambling_rats_r0' },
  ...
  { id: 'weapon_rack', title: '兵器架',
    ...
    choices: [
      { label: '挑一幅演招圖練習（從 3 張絕學牌中選擇 1 張）', outcome: [{ kind: 'chooseCard', pool: '絕學', n: 3 }], result: '球球看著牆上的三幅演招圖，拿起兵器試了試重量，再比對圖裡的動作。球球：「這個拿得動，先試它的招式喵。」', resultArt: 'weapon_rack_r0' },
      { label: '把整批舊兵器交給回收商（獲得 55 條小魚乾）', outcome: [{ kind: 'fish', n: 55 }], result: '老鼠把舊兵器搬上推車，付給球球 55 條小魚乾。球球點過數目，把小魚乾收好。球球：「這些鏽掉的也能賣，太好了喵。」', resultArt: 'weapon_rack_r1' },
    ] },
  ...
  { id: 'moving_rat', title: '換家的老鼠', acts: [2, 3],
    ...
    choices: [
      ...
      { label: '交換秘寶（隨機交出 1 件非起始秘寶；隨機獲得 2 件常見秘寶）',
        ...
        result: '老鼠拿走一件秘寶，再依約交給球球兩件。球球看了看換回來的東西，收進行囊。球球：「說好不挑的，就換這兩件吧喵。」', resultArt: 'moving_rat_r0' },
      { label: '不交換（無效果）', outcome: [], result: '球球搖搖頭，老鼠便把包袱綁回去。球球也整理好行囊，準備繼續走。球球：「我帶的都還用得上，不換了喵。」' },
    ] },

  { id: 'grindstone', title: '磨利我的刀', acts: [2, 3],
    text: '磨刀石旁刻著一套捨招法，開頭寫著：「招多不如招熟。」下面另有一行提醒：強行改掉熟練的招式，會傷及身體根基。球球：「練這個會傷身，得想清楚喵。」',
    choices: [
