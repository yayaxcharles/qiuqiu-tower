...
export const events: EventDef[] = [
  ...
  { id: 'feifei_pouch', title: '破掉的針袋', hero: 'feifei', acts: [1, 2],
    text: '菲菲在舊櫃裡找到一條乾淨布條，正想拿來替手換藥，針袋卻勾在櫃角上裂了開來。帶藥的針尖從破口露出，她連忙鬆手，只敢拎著袋口。布條比了比——補了袋子，就不夠替傷口換藥了。',
    choices: [
      { label: '布條拿來補針袋（獲得 1 張罕見的忍術牌）',
        outcome: [{ kind: 'addRandomCard', pool: '忍術', rarity: '罕見' }],
        result: '她把布條纏住破口，確認針尖不再露出，才將針袋放回腰邊。菲菲：「那個……我只是還能忍，沒有說不痛喔。」', resultArt: 'feifei_pouch_r0' },
      { label: '布條拿來包紮（回復 18 點生命）',
        outcome: [{ kind: 'heal', n: 18 }],
        result: '她用布條重新包紮傷口，又挑掉會從破口伸出的毒針，才敢把針袋收回去。菲菲：「我知道很浪費……可是我不想再被刺到。」傷口舒服了些，能安心帶走的毒針卻少了。', resultArt: 'feifei_pouch_r1' },
    ] },
  { id: 'feifei_signal', title: '牆後的暗號', hero: 'feifei', acts: [2, 3],
    text: '牆後響起她和師兄練功時約好的求援暗號，連她怕痛時亂掉的節奏都一樣。菲菲喊了聲停，敲擊卻沒有停下；她貼著門縫看，裡面只有轉動的齒輪。機關底下壓著一袋小魚乾，伸手拿就會碰到夾合的鐵片。',
    choices: [
  ...
  { id: 'daxia_teach', title: '師父留下的秘笈', fixedFloor: 5,
    ...
    choices: [
      { label: '研讀秘笈（從 3 張絕學牌中選擇 1 張）', outcome: [{ kind: 'chooseCard', pool: '絕學', n: 3 }], result: '球球攤開秘笈，比對三招的圖解。球球：「師父的字好醜，得先看清楚再決定學哪招喵。」', resultArt: 'daxia_teach_r0' },
  ...
  { id: 'robin', title: '分糧救急',
    ...
    choices: [
      { label: '分出目前一半的小魚乾（回復 15 點生命、移除 1 張牌）', outcome: [{ kind: 'flag', name: 'robin_shared' }, { kind: 'fishHalve' }, { kind: 'heal', n: 15 }, { kind: 'removeCard' }], result: '村貓替球球清理傷口，陪牠整理一路上的招式，找找有哪些已經用不上。球球：「魚乾分著吃，傷也互相照顧，這才叫江湖喵。」', resultArt: 'robin_r0' },
  ...
  { id: 'rescue', title: '江湖救急',
    ...
    choices: [
      { label: '收下貓草藥（回復 20 點生命）', outcome: [{ kind: 'flag', name: 'rescue_took_herb' }, { kind: 'heal', n: 20 }], result: '球球喝下貓草藥，苦得整張臉皺了起來，身上的傷痛卻緩和不少。球球：「謝禮我收到了，這個苦味大概也忘不掉喵。」', resultArt: 'rescue_r0' },
  ...
  { id: 'seclusion', title: '閉關',
    ...
    choices: [
      { label: '對著爪痕練招（升級至多 1 張牌）', outcome: [{ kind: 'upgradeCard' }], result: '球球照著牆上的爪痕比畫，琢磨自己的出手角度。球球：「再仔細看看，應該還有能練順的地方喵。」', resultArt: 'seclusion_r0' },
  ...
  { id: 'lost_kitten', title: '迷路的小黑貓',
    ...
    choices: [
      ...
      { label: '指出集合處，讓牠自己回去（獲得 15 條小魚乾）', outcome: [{ kind: 'fish', n: 15 }], result: '小黑貓聽見同伴的呼喚，終於破涕為笑，留下 15 條小魚乾後跑向轉角。球球：「慢慢走，牠們就在那邊喵。」', resultArt: 'lost_kitten_r1' },
    ] },
  ...
  { id: 'old_well', title: '古井',
    ...
    choices: [
      ...
      { label: '對著倒影練招（升級至多 1 張牌）', outcome: [{ kind: 'upgradeCard' }], result: '等水面靜下來，球球對著倒影比畫，仔細檢查自己的姿勢。球球：「平常只顧看對手，也該看看自己怎麼出招喵。」', resultArt: 'old_well_r1' },
  ...
  { id: 'broken_shrine', title: '倒了的神龕',
    ...
    choices: [
      ...
      { label: '拿走供品（獲得 45 條小魚乾、牌組加入 1 張壞毛病「走火入魔」）', outcome: [{ kind: 'fish', n: 45 }, { kind: 'addCard', cardId: 'zouhuo' }],
        result: '球球捲起供品就走，神像的微光卻化成一縷冷氣鑽進牠胸口，攪得氣息忽快忽慢。球球：「供品還附贈這個，怎麼不先寫清楚喵。」', resultArt: 'broken_shrine_r1' },
    ] },
  ...
  { id: 'cat_tower', title: '好高的貓抓柱',
    ...
    choices: [
      { label: '爬到頂端取物（最多失去 10 點生命，隨機獲得 1 件常見秘寶）', outcome: [{ kind: 'damage', n: 10 }, { kind: 'relic', pool: '常見' }],
        result: '球球攀到頂端，前腿被粗麻繩磨出幾道傷，總算把小包裡的秘寶取了下來。球球：「藏這麼高，是怕別的貓不肯爬喵。」', resultArt: 'cat_tower_r0' },
      { label: '照著底部爪痕練習（隨機獲得 1 張罕見絕學牌）', outcome: [{ kind: 'addRandomCard', pool: '絕學', rarity: '罕見' }],
        result: '球球沿著爪痕試了幾次出手，漸漸摸出其中一招的力道。球球：「原來不是亂抓，我差點把前輩的功夫磨掉了喵。」', resultArt: 'cat_tower_r1' },
    ] },
  ...
  { id: 'sleeping_guard', title: '睡著的守衛',
    ...
    choices: [
      ...
      { label: '調勻氣息，悄悄通過（生命上限與當前生命各 +4）', outcome: [{ kind: 'maxHp', n: 4 }], result: '球球放慢呼吸，一步步避開鬆動的地磚。走過門邊時，牠已摸出讓呼吸與步伐配合的方法，氣息比先前穩了些。球球：「原來不用憋到臉都歪掉，也能走得很輕喵。」', resultArt: 'sleeping_guard_r1' },
    ] },

  { id: 'medicine_cat', title: '賣藥的三花貓',
    text: '一隻三花貓在牆邊擺攤，一邊放著混裝的忍具，一邊排著祖傳補身藥。「忍具隨手拿，藥水照方熬；想買哪一邊，先看清價錢。」',
    choices: [
      { label: '購買混裝忍具（支付 25 條小魚乾，隨機獲得 2 個忍具）', costFish: 25, outcome: [{ kind: 'potions', n: 2 }], result: '三花貓收妥小魚乾，從箱裡隨手取出兩個忍具交給球球。球球：「拿到什麼就用什麼，也算考驗臨場反應喵。」', resultArt: 'medicine_cat_r0' },   // 文案照使用者 2026-09-06（結果句也講「忍具」，不再講「瓶子」）
      { label: '購買祖傳補身藥（支付 60 條小魚乾，生命上限與當前生命各 +12）', costFish: 60, outcome: [{ kind: 'maxHp', n: 12 }], result: '球球付了錢，照三花貓的指示把藥喝下。暖意慢慢散開，四肢也更有力了。球球：「價錢讓我心疼，藥倒是有下本喵。」', resultArt: 'medicine_cat_r1' },
  ...
  { id: 'stuck_kitten', title: '卡住的小貓',
    ...
    choices: [
      ...
      { label: '上前協助救出小貓（獲得 20 條小魚乾，回復 15 點生命）', outcome: [{ kind: 'heal', n: 15 }, { kind: 'fish', n: 20 }],
        result: '球球扶穩小貓，配合牠媽媽把牠慢慢帶出欄杆。母貓拿出傷藥替球球處理舊傷，再送上 20 條小魚乾。球球：「下次先量鬍鬚，再決定頭要不要過去喵。」', resultArt: 'stuck_kitten_r0' },
  ...
  { id: 'heavy_door', title: '很重的門',
    ...
    choices: [
      { label: '硬推石門，進去取寶（最多失去 14 點生命，隨機獲得 1 件大魔物秘寶）', outcome: [{ kind: 'damage', n: 14 }, { kind: 'relic', pool: '大魔物' }],
        result: '球球用肩膀頂開石門，皮肉被粗糙的門面擦傷，總算進到角落，從寶箱取出一件秘寶。球球：「寶箱沒上鎖，門倒是把力氣全省下來刁難我喵。」', resultArt: 'heavy_door_r0' },
  ...
  { id: 'old_master_ghost', title: '師父的影子',
    ...
    choices: [
      ...
      { label: '聽完指點，練習調息（升級一張牌，生命上限與當前生命各 +5）', outcome: [{ kind: 'upgradeCard' }, { kind: 'maxHp', n: 5 }],
        result: '球球跟著指點放慢吐納，重新練穩一招，原本急促的氣息也沉了下來。球球：「連嫌我太急的口氣都一樣，真讓貓想頂嘴喵。」', resultArt: 'old_master_ghost_r0' },
      { label: '有所領悟，捨去不合適的兩張牌（移除 2 張牌）', outcome: [{ kind: 'removeCard' }, { kind: 'removeCard' }],
        result: '球球抬爪打住，把那套動作從頭試了一遍，索性把兩招硬留著的都放下了。模糊的身影靜靜看著牠。球球：「不合步子的招，留著只會一直急喵。」', resultArt: 'old_master_ghost_r1' },
    ] },
  ...
  { id: 'catnip_field', title: '一整片貓薄荷',
    ...
    choices: [
      { label: '進去打滾（回復相當於生命上限 50% 的生命，加入 1 張壞毛病牌「走火入魔」）', outcome: [{ kind: 'healPercent', p: 0.5 }, { kind: 'addCard', cardId: 'zouhuo' }],
        result: '球球在葉叢裡滾得筋骨鬆開，卻把葉間的異氣一併吸進體內，起身後氣息仍亂竄，遲遲壓不下來。球球：「舒服是真的，停不下來也是真的喵。」', resultArt: 'catnip_field_r0' },
      { label: '採一把嫩葉交換（隨機獲得 2 個忍具）', outcome: [{ kind: 'potions', n: 2 }],
        result: '球球採好嫩葉交給老貓，換回從備用品箱隨手取出的兩個忍具。球球：「先把香味留在園子裡，有用的帶走就好喵。」', resultArt: 'catnip_field_r1' },
  ...
  { id: 'weapon_rack', title: '兵器架',
    ...
    choices: [
      { label: '挑一幅演招圖練習（從 3 張絕學牌中選擇 1 張）', outcome: [{ kind: 'chooseCard', pool: '絕學', n: 3 }], result: '球球把三幅圖上的發力路線仔細看了一遍，又掂了掂架上的兵器。球球：「兵器沉不沉是一回事，招式順不順手才要緊喵。」', resultArt: 'weapon_rack_r0' },
      { label: '把整批舊兵器交給回收商（獲得 55 條小魚乾）', outcome: [{ kind: 'fish', n: 55 }], result: '老鼠把舊兵器搬上推車，清點後付給球球 55 條小魚乾。球球：「鏽成這樣還有人收，也算替它們找了條出路喵。」', resultArt: 'weapon_rack_r1' },
    ] },

  { id: 'crying_wall', title: '會哭的牆',
    text: '牆面的水痕像一張哭臉，細細的聲音反覆說著：「別上去……」旁邊的殘字記著，這是昔日護塔者留在石中的一縷意念。牆腳另有一塊鬆動的藏物磚，縫裡露出布包的一角。',
    choices: [
      { label: '耐心安慰，聽完它的叮囑（生命上限與當前生命各 +8）', outcome: [{ kind: 'maxHp', n: 8 }], result: '球球告訴它，自己還得往上找師父。哭聲慢慢平靜，轉而教牠一段護身吐納法；球球跟著練習，氣息逐漸深長。球球：「上面危險，我記住了；你教的這口氣，我也會記住喵。」', resultArt: 'crying_wall_r0' },
      { label: '敲開牆腳的藏物磚（隨機獲得 1 件常見秘寶；失去最多 12 點生命）', outcome: [{ kind: 'relic', pool: '常見' }, { kind: 'damage', n: 12 }],
        result: '球球避開刻字的牆面，從藏物磚後取出包著秘寶的布包，收爪時卻被碎石割傷。上方的低語仍在反覆提醒。球球：「東西拿到了，你的叮囑我也聽見了喵。」', resultArt: 'crying_wall_r1' },
    ] },

  { id: 'fish_pond', title: '養魚的池子',
    text: '小池裡的胖魚慢吞吞地游著，池邊放了一籃小魚乾。球球才伸出爪子，水下便掠過一道比魚大得多的黑影。球球：「游這麼慢，是在考驗我的忍耐力喵。」',
    choices: [
      { label: '抓一條吃（回復 18 點生命）', outcome: [{ kind: 'heal', n: 18 }], result: '球球抓了一條魚，躲到池邊慢慢吃完，肚子終於不再咕嚕叫。球球：「一條就夠了，再抓我怕自己捨不得走喵。」', resultArt: 'fish_pond_r0' },
      { label: '搬走池邊的小魚乾（獲得 65 條小魚乾；失去最多 10 點生命）',
        outcome: [{ kind: 'fish', n: 65 }, { kind: 'damage', n: 10 }],
        result: '球球抱起魚乾籃，池水忽然翻湧，一條粗大的尾巴掃上岸，把牠拍得滾了半圈。牠爬起來，抱緊魚乾就跑。球球：「原來這籃有主人喵！」', resultArt: 'fish_pond_r1' },
  ...
  { id: 'moon_window', title: '看得到月亮的窗',
    ...
    choices: [
      { label: '放下 20 條小魚乾（生命上限與當前生命各 +10）', costFish: 20, outcome: [{ kind: 'maxHp', n: 10 }],
        result: '球球把小魚乾放進碗裡。碗底的小貓浮出淡淡光影，在牠胸前蹭了一下，呼吸便比先前更沉穩了。球球：「你吃你的，不用跟我客氣喵。」', resultArt: 'moon_window_r0' },
      { label: '坐著看月亮（回復 14 點生命）', outcome: [{ kind: 'heal', n: 14 }], result: '球球在窗邊坐了一會兒，繃緊的肩背漸漸鬆開，爪墊也沒那麼痠了。球球：「月亮又不會跑，讓我多看一下喵。」', resultArt: 'moon_window_r1' },
    ] },
  ...
  { id: 'greedy_merchant', title: '很貪心的商人',
    ...
    choices: [
      ...
      { label: '接受灌功試驗（牌組加入 1 張壞毛病「內力不足」；隨機獲得 1 件大魔物秘寶）',
        ...
        result: '灰貓收功後，把約好的秘寶推過來。球球一提氣，才發現運氣的節奏被攪亂了。球球：「小字寫得那麼小，毛病倒是很清楚喵。」', resultArt: 'greedy_merchant_r1' },
  ...
  { id: 'toll_again_paid', title: '山賊再現', acts: [2, 3], requiresFlag: 'toll_paid',
    ...
    choices: [
      ...
      { label: '請牠把回禮留給母親（生命上限與當前生命各 +5）', outcome: [{ kind: 'maxHp', n: 5 }], result: '山賊收回包裹，想了想，改把母親教的調息法示範給球球。球球跟著練了幾次，呼吸漸漸沉穩。球球：「這個我收下，下次別再攔路搶錢了喵。」', resultArt: 'toll_again_paid_r1' },
    ] },
  ...
  { id: 'rescue_return_herb', title: '村貓的回禮', acts: [2, 3], requiresFlag: 'rescue_took_herb',
    ...
    choices: [
      { label: '收下回禮（隨機獲得 1 件常見秘寶）', outcome: [{ kind: 'relic', pool: '常見' }], result: '村貓解開布包，把珍藏的秘寶交給球球，還仔細包好了邊角。球球：「你有好好活著，就是最好的回禮喵。」', resultArt: 'rescue_return_herb_r0' },
  ...
  { id: 'rescue_return_fish', title: '欠村貓的那一份', acts: [2, 3], requiresFlag: 'rescue_took_fish',
    ...
    choices: [
      { label: '分給牠 40 條小魚乾（回復 25 點生命，自選移除 1 張牌）', costFish: 40, outcome: [{ kind: 'heal', n: 25 }, { kind: 'removeCard' }], result: '村貓接過小魚乾，堅持用留下的藥替球球處理傷口。歇息時，球球重新整理招式，思考往後要留下哪些路數。球球：「這次先吃飽，再想接下來怎麼走喵。」', resultArt: 'rescue_return_fish_r0' },
      { label: '低頭趕路（牌組加入 1 張壞毛病「眼冒金星」）', outcome: [{ kind: 'addCard', cardId: 'dazed_card' }], result: '球球低著頭快步走開，腦中卻一直浮現村貓勉強擠出的笑。牠越想越恍神，連眼前的階梯都晃了起來。球球：「我知道牠還在等人幫忙……喵」', resultArt: 'rescue_return_fish_r1' },
    ] },
  { id: 'robin_feast', title: '村貓的謝宴', acts: [2, 3], requiresFlag: 'robin_shared',
    ...
    choices: [
      { label: '坐下吃頓飽的（生命回復至上限）', outcome: [{ kind: 'healPercent', p: 1 }], result: '村貓們輪流添湯，球球終於放慢吃飯的速度，吃到肚子圓得像顆球。球球：「這一碗，可以不用邊吃邊趕路喵。」', resultArt: 'robin_feast_r0' },
  ...
  { id: 'grindstone', title: '磨到只剩一把刀', acts: [2, 3],
    ...
    choices: [
      ...
      { label: '依照捨招法修行（自選移除 3 張牌；本次登塔生命上限 −8）',
        ...
        result: '球球照著石上的方法重新整理招式，準備捨去不再需要的路數。強練留下的虛耗卻沉在胸口，牠知道這次不能靠睡一覺補回。球球：「留下的招式，得更認真用了喵。」', resultArt: 'grindstone_r0' },
      { label: '不修行（無效果）', outcome: [], result: '球球讀完最後一行，收回已經伸出的爪子。球球：「要捨哪一招，等我想清楚再說喵。」' },
    ] },

  { id: 'shortcut_scroll', title: '速成的卷軸', acts: [1, 2, 3],
    text: '牆上釘著一卷攤開的卷軸，墨跡還沒乾。最上方幾個大字寫著：「一練就會！」下面的小字卻是：「後果自負。」球球：「大字這麼有把握，後果故意寫那麼小喵。」',
    choices: [
      ...
      { label: '照著練（自選升級至多 2 張牌；牌組加入 1 張隨機壞毛病牌）',
        ...
        result: '球球試著把卷軸上的訣竅套進熟悉的招式，卻在收勢時察覺一絲不對勁。牠又看了一眼那行小字。球球：「便宜的功夫，果然會挑別的地方收帳喵。」', resultArt: 'shortcut_scroll_r0' },
