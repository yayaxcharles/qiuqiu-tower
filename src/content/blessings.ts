...
export const BLESSINGS: readonly BlessingDef[] = [
  // ===== 安全：穩穩拿一樣 =====
  { id: 'bless_rations', cls: '安全', art: 'codex/bless_rations', effects: [{ kind: 'maxHp', n: 6 }] },
  { id: 'bless_coins', cls: '安全', art: 'codex/bless_coins', effects: [{ kind: 'fish', n: 90 }] },
  { id: 'bless_potions', cls: '安全', art: 'codex/bless_potions', effects: [{ kind: 'potions', n: 3 }] },
  { id: 'bless_charm', cls: '安全', art: 'codex/bless_charm',
    effects: [{ kind: 'nextFight', fights: 5, note: '的護身符閃了一下紅光，魔物們都翻了肚', effects: [{ kind: 'status', name: '翻肚', amount: 2, target: 'all' }] }] },
  // ===== 換牌：改自己的牌組 =====
  { id: 'bless_scissors', cls: '換牌', art: 'codex/bless_scissors', effects: [], pick: { kind: 'remove', n: 3 } },
  { id: 'bless_notes', cls: '換牌', art: 'codex/bless_notes', effects: [], pick: { kind: 'upgrade', n: 2, upTo: true } },
  { id: 'bless_moves', cls: '換牌', art: 'codex/bless_moves', effects: [], pick: { kind: 'choose', n: 3, pool: '忍術', rarity: '稀有', upgraded: true } },
  { id: 'bless_doodle', cls: '換牌', art: 'codex/bless_doodle', effects: [], pick: { kind: 'transform', n: 2 } },
  // ===== 代價：好東西，但要付一樣 =====
  { id: 'bless_treasure', cls: '代價', art: 'codex/bless_treasure',
    effects: [{ kind: 'relic', pool: '塔主' }, { kind: 'addCard', cardId: 'shishou' }, { kind: 'addCard', cardId: 'shishou' }] },
  { id: 'bless_stash', cls: '代價', art: 'codex/bless_stash', effects: [{ kind: 'fish', n: 200 }, { kind: 'maxHp', n: -6 }] },
  { id: 'bless_box', cls: '代價', art: 'codex/bless_box', effects: [{ kind: 'relic', pool: '塔主' }], loseStarter: true },
  ...
  { id: 'bless_dice', cls: '賭運氣', art: 'codex/bless_dice', effects: [], dice: [
    ...
    { max: 6, effects: [{ kind: 'relic', pool: '大魔物' }] },
  ] },
  ...
  { id: 'bless_wine', cls: '賭運氣', art: 'codex/bless_wine',
    effects: [{ kind: 'gamble', p: 0.5, win: [{ kind: 'maxHp', n: 15 }], lose: [{ kind: 'maxHp', n: -5 }] }] },
];
