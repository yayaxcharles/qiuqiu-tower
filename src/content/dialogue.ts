...
export const feifeiDialogue = {
   ...
   */
  battleStart: ['那個……借過一下。', '針上有毒，別碰。', '別追了，前面沒路啦！', '袖口綁緊，免得礙手。', '再靠近，我就丟針了。', '可以別打臉嗎……拜託。', '我不跟你比力氣。', '師兄碰上你，會怎麼辦呢？', '你一定要守在這裡嗎？', '看牠的手，別只顧著怕。', '等一下，衣服勾住了！', '我只是想把人接回家。', '師父教過這個，我記得。', '出口在後面，記住了。'],
...
export const dangdangDialogue = {
  ...
  prologue: <DialogueLine[]>[
    ...
    { speaker: '旁白', text: '菲菲跟在後面，把竹筒放到桌上。那個扣環，她試了兩次才扣上。' },
    { speaker: '菲菲', text: '這個也麻煩你。針我都拿出來了。' },
    { speaker: '噹噹', text: '放這邊。你們吃過飯再來拿。', slideBreak: true },
    { speaker: '旁白', text: '那天夜裡，村外冒出魔塔。大俠貓被魔氣控制，衝向塔頂，球球追了上去。魔物趁亂搬走糧箱，撞歪了村口的門。' },
    { speaker: '旁白', text: '噹噹架起銅護臂擋住魔物，讓抱著糧袋的村貓先過。等最後一隻小貓進了門，他才推上門閂。' },
    ...
    { speaker: '旁白', text: '傍晚，兩隻村貓扛來木料，接過噹噹的錘子。門外的魔物退了，糧食也都搬進屋裡。' },
    { speaker: '旁白', text: '守門的村貓說：「這邊交給我們。你去吧。」' },
    { speaker: '旁白', text: '噹噹帶上工具袋，扣好銅護臂。走到塔下，他回頭看了一眼，村口已經點起燈。' },
...
const MIXED_SCENES: Readonly<Record<string, {
  ...
  'dangdang+ninja': {
    ...
    victory: [
      ...
      { speaker: '旁白', text: '球球把工具袋拿過來。大俠貓替噹噹揉了揉手臂，三人歇過氣，才帶著找回的小魚乾下樓。', slideBreak: true },
  ...
  'dangdang+feifei': {
    ...
    victory: [
      ...
      { speaker: '旁白', text: '菲菲剪開扣帶，大俠貓接住掉下來的銅護臂。四人歇了一會兒，帶著小魚乾一起下樓。' },
