...
export const FEIFEI_EVENT_TEXT: Readonly<Record<string, string>> = {
  ...
  '球球護住魚乾袋，亮出爪子。山賊舉起木棒，朝轉角張望，像在等誰接應。球球：「想拿我的小魚乾，就自己來搶喵。」':
    '菲菲把魚乾袋護在身後，抽出一根針。山賊舉起木棒，朝轉角張望，像在等誰接應。菲菲：「不要過來……我的針有毒，我有先提醒你喔。」',
  '村貓們輪流添湯，球球終於放慢吃飯的速度，吃到肚子圓得像顆球。球球：「這一碗，可以不用邊吃邊趕路喵。」':
    '村貓們輪流添湯，菲菲終於放慢吃飯的速度，一口一口把碗裡的湯喝完。菲菲：「吃得好飽……我都忘了，吃飯可以不用那麼緊張。」',
  '走廊兩側排滿鏡子，無數個球球同時抬起頭。其中一面慢了半拍，接著，鏡中的球球竟先擺出了迎戰的架勢。':
    '走廊兩側排滿鏡子，無數個菲菲同時抬起頭。其中一面慢了半拍——鏡子裡那個菲菲沒有跟著眨眼，反而先握緊了針，擺出迎戰的架勢。',
  ...
  '鏡中的身影踏出鏡面，照著球球的動作抬起前爪。球球也壓低身子，準備接招。球球：「連我準備出哪一爪都知道，這場可不好混喵。」':
    ...
    '鏡中的菲菲踏出鏡面，連握針的手勢都跟她一模一樣，只有眼神冷得不像她。菲菲往後退了半步，把針換到另一隻手。菲菲：「那個……你連我發抖都學，能不能不要靠過來？」',
  '球球把目光固定在走廊盡頭，快步走出鏡子的包圍。球球：「先找到師父，再處理這麼多個我喵。」':
    '菲菲低著頭，不去看鏡子裡那些跟自己一樣的臉，貼著另一側的牆快步走出走廊。菲菲：「我還要找師父跟師兄……先出去，別看鏡子了。」',
};
