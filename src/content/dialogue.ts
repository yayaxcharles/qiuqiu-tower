...
export const feifeiDialogue = {
   ...
   */
  battleStart: ['那個……先別過來。', '我先丟一根試試。', '不要追我喔，我跑得很快的。', '一層就好……不對，還是多疊幾層好了。', '針還夠，藥也還夠。', '拜託站遠一點。', '我不跟你比力氣。', '師兄的話現在一定已經衝進怪堆裡了。'],
  battleWin: ['……倒了？真的倒了？', '我有先提醒你喔。', '毒有生效，太好了。', '呼……還好不用補第二輪。', '手、手還在抖。', '你如果不要追我，就不會變這樣了。', '這樣算我贏吧？', '我要坐一下……腿軟了。', '師父，我沒有硬碰喔。', '好餓……下毒也很累的。'],
  hungry: ['沒力氣了……針會丟歪。', '飯糰……沒有了。', '肚子好餓，連藥味都聞起來像湯。'],
  lowHp: ['不要過來——我真的會痛！', '我我我真的要回家了……', '等一下！毒還沒發作，你先站遠一點！'],
  chestLines: ['箱子……裡面該不會有東西吧。', '我先用針戳一下，不算弄壞吧？', '有人在裡面的話先說一聲，我的針有毒。', '站遠一點再開好了。', '希望是繃帶……或解毒藥。等等，解毒藥好像是給別人用的。'],
  restNapLines: ['睡一下下就好……一下下。', '這裡應該沒有東西會突然撲過來吧。', '先把毒針收好，睡著壓到會很糟。', '眼睛好澀……今天丟太多針了。'],
  restSharpenLines: ['磨利一點，扎得淺也能把藥送進去。', '我力氣小，所以針一定要準。', '再上一層藥……薄薄的就好。', '師父說過，會準備的人，不需要逞強。'],
  victoryTeaser: '毒疊好了……那我就先走囉。',
};
