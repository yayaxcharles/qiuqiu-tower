...
export const potions: PotionDef[] = [
  ...
  { id: 'whetstone', name: '爪力粉', text: '這場戰鬥獲得 1 點爪力。', art: 'codex/potion_whetstone', price: 30, target: 'self', effects: [{ kind: 'status', name: '爪力', amount: 1, target: 'self' }] },
// ===== 2026-08-31 補 12 個。本來只有 8 個，一局就用掉五到十個，等於每局都在用同一批 =====
  ...
  { id: 'claw_oil', name: '爪力膏', text: '這場戰鬥獲得 3 點爪力。', art: 'codex/potion_claw_oil', price: 50, target: 'self', effects: [{ kind: 'status', name: '爪力', amount: 3, target: 'self' }] },
  ...
  { id: 'needle_rain', name: '三連針', text: '對目標造成 4 點傷害，打 3 次。', art: 'codex/potion_needle_rain', price: 45, target: 'enemy', effects: [{ kind: 'damage', amount: 4, times: 3 }] },
  ...
  { id: 'dried_fish_bundle', name: '兩顆飯糰', text: '本回合多 2 顆飯糰。', art: 'codex/potion_dried_fish_bundle', price: 55, target: 'self', effects: [{ kind: 'energy', n: 2 }] },
  { id: 'secret_scroll', name: '半卷殘頁', text: '抽 2 張牌，並多 2 顆飯糰。', art: 'codex/potion_secret_scroll', price: 55, target: 'self', effects: [{ kind: 'draw', n: 2 }, { kind: 'energy', n: 2 }] },
  { id: 'iron_paw', name: '鐵指虎', text: '對目標造成 16 點傷害。', art: 'codex/potion_iron_paw', price: 60, target: 'enemy', effects: [{ kind: 'damage', amount: 16 }] },
  ...
  { id: 'iron_salve', name: '金鐘罩膏', text: '本回合不受任何傷害。', art: 'codex/potion_iron_salve', price: 75, target: 'self',
