...
import { bestRelic, bestUpgrade, deckJunk, eventValue, napWorks, pickCard, rating, relicRating, setBonusScore, shopAtMerchant, smartPending, smartSeatAct } from './smartbot';
