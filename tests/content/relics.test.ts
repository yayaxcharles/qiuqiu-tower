...
describe('秘寶', () => {
  it('75 件、池數正確、id 不重複', () => {
    expect(relics.length).toBe(75);   // 75＝2026-09-15 塔主池加 9 件（使用者：重複率太高）   // 60＝2026-09-02 擴充（36 → 60）；65＝2026-09-04 五件代價秘寶；66＝2026-09-12 菲菲的起始秘寶（2026-09-13 改名毒針袋）
    ...
    expect(new Set(relics.map((r) => r.id)).size).toBe(75);
