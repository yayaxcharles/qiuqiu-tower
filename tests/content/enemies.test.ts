...
describe('魔物資料', () => {
  it('數量：一般 68、大魔物 16、塔主 11、召喚 16', () => {
    ...
    // 召喚 15→16＝2026-09-11 鼠親兵（使用者：鼠大將帶的小兵太弱，原本帶的是第一關的小老鼠兵）
    expect(n('大魔物')).toBe(16); expect(n('塔主')).toBe(11); expect(n('召喚')).toBe(16);
  ...
  it('塔主三條血：120／240／300，血條式變身', () => {
    ...
    expect(boss.phases?.[1]?.strengthPerTurn).toBe(1);   // 第三條血每回合 +1（2026-09-06 從 2 改）
