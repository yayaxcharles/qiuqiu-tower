...
def main() -> None:
    ...
    for name, prompt in jobs.items():
        ...
        for attempt in range(1, args.retries + 1):
            try:
                subprocess.run([*CMD, *ref, prompt], capture_output=True, text=True, timeout=args.timeout)
