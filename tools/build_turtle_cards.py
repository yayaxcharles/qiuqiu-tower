...
add('zhuangji', '撞擊', '起手', '常見', '攻擊', 1, '造成等同於蜷縮數值的傷害，蜷縮會消失。', '費用變 0。', 0, '', '獨有：起手的招牌，打完蜷縮歸零（跟太極不同）；需新效果「蜷縮換傷害」')
...
add('mojia', '磨甲', K, '稀有', '技能', 3, '打出時把你現在的蜷縮乘以 2 倍。', '打出時把你現在的蜷縮乘以 3 倍。', 3, '', '獨有：一次性翻倍（使用者 2026-09-03 定案），所以算技能不是能力；需新效果「蜷縮加倍」')
...
add('jiliang', '甲裂', K, '罕見', '攻擊', 2, '造成等同於蜷縮數值的傷害，蜷縮不減。', '費用變 1。', 1, 'taiji', '效果同球球的太極（蜷縮不減），是撞擊的進階版')
